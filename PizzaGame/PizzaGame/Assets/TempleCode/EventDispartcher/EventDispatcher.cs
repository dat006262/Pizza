...
namespace DemoObserver
{
        ...
        public static EventDispatcher Instance
        {
            get
            {
                ...
                if (s_instance == null)
                {
                    ...
                    singletonObject.transform.SetParent(GlobalSetting.Instance.transform);
                }
                return s_instance;
            }
            private set { }
    ...
    public static class EventDispatcherExtension
    {
        ...
        public static void RemoveListenner(this MonoBehaviour listener, EventID eventID, Action<object> callback)
        {
